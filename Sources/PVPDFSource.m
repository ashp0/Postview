...
// pt banner became a 612 x 300 pt page: -createImageForPage: then asks
// CGPDFPageGetDrawingTransform to fit the real crop box into that frame, which
// preserves aspect and so draws the banner as a 612 x 7 pt strip marooned in a
// 612 x 300 pt page, with the rest of the frame blank. The page is not distorted
// but it is the wrong page, and nothing anywhere says so.
//
